...
if [[ "$OS_NAME" == "darwin" ]]; then
    ...
    git clone https://github.com/pyenv/pyenv-virtualenv.git $(pyenv root)/plugins/pyenv-virtualenv || echo "Already exist..."
fi
...
pyenv install 3.6.11 || echo "Already exist..."

echo "==> ${LBLUE}Installing Python 3.7.8…${END}"
pyenv install 3.7.8 || echo "Already exist..."

echo "==> ${LBLUE}Installing Python 3.8.5…${END}"
pyenv install 3.8.5 || echo "Already exist..."
